module seq_flux_moab
  ...
  public seq_flux_init_moab
  public seq_flux_readnl_moab
  public seq_flux_initexch_moab

  public seq_flux_ocnalb_moab

  public seq_flux_atmocn_moab2
! public seq_flux_atmocn_moab
  
  public seq_flux_atmocnexch_moab
...
contains
  ...
  subroutine seq_flux_readnl_moab (nmlfile, ID)
    ...
    character(len=*),parameter :: subname = '(seq_flux_readnl_moab) '
  ...
  end subroutine seq_flux_readnl_moab

  !===============================================================================

  subroutine seq_flux_initexch_moab(atm, ocn, mpicom_cplid, cplid)
    ...
    character(*),parameter :: subName =   '(seq_flux_initexch_moab) '
    !-----------------------------------------------------------------------
...
! update MOAB versions
  ...
  end subroutine seq_flux_ocnalb_moab


  !===============================================================================

  subroutine seq_flux_atmocnexch_moab( infodata, atm, ocn, fractions_a, fractions_o, &
       xao_a, xao_o)
    ...
    !
    character(*),parameter :: subName =   '(seq_flux_atmocnexch_moab) '
    !
    !-----------------------------------------------------------------------
  ...
  end subroutine seq_flux_atmocnexch_moab

  !===============================================================================

  subroutine seq_flux_atmocn_moab2(infodata, tod, dt, a2x, o2x, xao)
    ...
    !
    character(*),parameter :: subName =   '(seq_flux_atmocn_moab2) '
    !
    !-----------------------------------------------------------------------
  ...
  end subroutine seq_flux_atmocn_moab2
  !===============================================================================

end module seq_flux_moab
